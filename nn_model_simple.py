...
class NN(nn.Module):
    ...
    """
    def __init__(self, hidden_size, depth, dropout, num_layers, ):
...
class NeuralNetwork(nn.Module):
    """A NeuralNetwork is a model which contains a message passing network following by feed-forward layers."""
